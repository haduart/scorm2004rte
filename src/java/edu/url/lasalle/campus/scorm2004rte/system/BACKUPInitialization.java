// $Id: Initialization.java,v 1.5 2008/02/12 15:43:22 ecespedes Exp $
/*
...
import org.campusproject.osid.shared.Properties;
...
public class Initialization {
    ...
    /**
     * String propietats de les finestres d'ajuda.
     */
    ...
    public Initialization() throws InitializationException {
        try {
            ...
            if (language == null) {
                ...
                language = "ca";//configurationRequest.getProperty("idLanguage");
     ...
     * @return
     */
    public final String getHelpProperties() {
