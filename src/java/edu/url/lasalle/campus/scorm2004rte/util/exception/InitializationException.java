...
* @version Versió $Revision: 1.2 $ $Date: 2008/01/31 10:12:56 $
* $Log: InitializationException.java,v $
* Revision 1.2  2008/01/31 10:12:56  msegarra
* *** empty log message ***
*
* Revision 1.1  2007/12/10 14:21:40  msegarra
* Implementa una excepció per a quan s'hagi d'indicar que hi ha hagut un problema a l'inicialitzar els JSPs.
*
*/
